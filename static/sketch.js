...
let angleIncrement = 5; // Define the angle increment for rotation
...
function mousePressed() {
    ...
    // set the symmetry to a random number between 5 and 13
...
function draw() {
  ...
  rotate(currentAngle); // Rotate the canvas by the current angle
  currentAngle += angleIncrement; // Increment the angle for the next frame
